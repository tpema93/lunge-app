...
export const NewProfile = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try{
            ...
            const response = await fetch('https://www-student.cse.buffalo.edu/CSE442-542/2024-Spring/cse-442j/tiff-backend/set-new-profile.php', {
                method: 'POST',
                body: formData,
            });
            console.log("posted");
        ...
        <div className='new-profile-container'>
            ...
            <div className='new-profile-left-column'>
                ...
                <div className='name-container'>
                    First Name:
                    <br />
                    <input type='text' className='new-profile-text' name='FirstName' maxLength='25' value={FirstName} readOnly onChange={(e) => setFirstName(e.target.value)}/>
                    <br />
                    Last Name: 
                    <br />
                    <input type='text' className='new-profile-text' name='LastName' maxLength='25' value={LastName} readOnly onChange={e => setLastName(e.target.value)}/>
                </div>

                <div className='birthday-container'>
                    Birthday: 
                    <br />
                    <input type='date' className='new-profile-birthday' name='Birthday' onChange={e => setBirthday(e.target.value)}/>
                </div>
                ...
                <div className='your-gender-container'>
                    ...
                    { userGenderShowOther && 
                        <div className='show-other-gender-button'> 
                            ...
                            <input type='text' className='new-profile-text'name='OtherGenderField' onChange={e => changeOtherGender(e.target.value)} />
                        </div>
                    }
                ...
                <div className='bio-container'>
                    About you:
                    <br />
                    <textarea name='Bio' className='new-profile-bio' maxLength='500' onChange={(e) => setUserBio(e.target.value)}/>
                </div>
            </div>
                    ...
                    <div className='image-row-top'>
                        ...
                        <div className='image-container'>
                            <div className='upload-image-square'>
                                {uploadedImage1 &&
                                    <img className='uploaded-image' src={URL.createObjectURL(uploadedImage1)} />
                                }
                            </div>
                            ...
                            <div className='image-interact-plus' >
                                <label className='upload-image-label'>
                                    <input id='files' type='file' className='file-input' accept="image/*" onChange={(e) => setUploadedImage1(e.target.files[0])} />
                                </label>
                        ...
                        <div className='image-container'>
                            <div className='upload-image-square'>
                                {uploadedImage2 &&
                                    <img className='uploaded-image' src={URL.createObjectURL(uploadedImage2)} />
                                }
                            </div>
                            ...
                            <div className='image-interact-plus' >
                                <label className='upload-image-label'>
                                    <input id='files' type='file' className='file-input' accept="image/*" onChange={(e) => setUploadedImage2(e.target.files[0])} />
                                </label>
...
<div>
        ...
        if (!Boolean(uploadedImage1)) {
            ...
            console.log('NEWIMAGECOUNT: ' + JSON.stringify(newImageCount));
